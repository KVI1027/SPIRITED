...
fetch('./item.json')
    ...
    .then(function (myJson) {
        ...
        if (document.body.clientWidth > 1199) {
            ...
            Create_sm(item);
            // 選擇到的類別icon效果(預設)
            const swiperSlidesSM = document.querySelectorAll('.web main .shop .shop-main-phone .top .kanban .types .swiper-slide')
            console.log(swiperSlidesSM);
            swiperSlidesSM[item_index].classList.add('swiper-SELECTED-sm');
        }
        ChangeSize(item);
        // fortuneCookies(item);
    });
...
function info_btn() {
    let active = document.querySelectorAll('.swiper-slide-active')
    ...
    if (element.introduce_ch != "") {
        ...
        <div class="menu-info description-phone">
            ...
            <div class="info-btn" onclick="info_btn()">
             <span class="info-en">Preservation</span>    <span class="info-ch">保存方式</span>
            </div>
        </div>
        ...
        <div class="menu-info preservation-phone">
            ...
            <div class="info-btn" onclick="info_btn()">
              <span class="info-en">Description></span>   <span class="info-ch">商品描述</span>
            </div>
        </div>
        `
    }
        ...
        var swiper_item_icon = new Swiper(".mySwiper-item-icon", {
            ...
            on: {
                click: function () {
                    ...
                    console.log(swiper_item_icon.clickedIndex);
                    if (swiper_item_icon.clickedIndex == 0) {
                        item_index = 0
                        clickEvent(0)
